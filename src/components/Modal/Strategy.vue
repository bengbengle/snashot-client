...
console.log('extendedStrategy:', extendedStrategy)
console.log('strategiesResults:', strategiesResults)
...
async function selectStrategy(strategyName) {
  ...
  console.log('extendedStrategy.value?.example::', extendedStrategy, extendedStrategy.value, 'defaultParams:', defaultParams)
  const params = extendedStrategy.value?.examples&&extendedStrategy.value?.examples[0]?.strategy?.params || defaultParams;
